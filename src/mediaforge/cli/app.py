...
from mediaforge.cli.menus import (
    ACTION_BACK,
    show_playlist_menu,
    show_video_menu,
)
from mediaforge.cli.output import print_banner, print_rule
...
def run() -> None:
    ...
    from mediaforge.settings.store import reload_settings
...
def _goodbye() -> None:
    ...
    console.print(
        Panel(
            Text.from_markup("[bold cyan]Thanks for using MediaForge. Goodbye![/]"),
            border_style="cyan",
            padding=(0, 4),
        )
    )
