...
from mediaforge.cli.summary import build_summary, render_summary
...
from mediaforge.downloader.validator import DownloadValidationResult, validate_download
from mediaforge.models.media import AnalysisResult
from mediaforge.playlist.models import PlaylistJob, PlaylistSelectionMode
...
from mediaforge.utils.exceptions import DownloadError
...
def _warn_environment_once() -> None:
    ...
    from mediaforge.utils.environment import environment_warnings
...
def execute_settings(state: WizardState) -> None:
    ...
    from mediaforge.settings.store import save_settings, set_current
...
def execute_playlist(state: WizardState, result: AnalysisResult) -> None:
    ...
    from mediaforge.playlist.models import PlaylistItem
...
def _run_queued(manager: DownloadManager, total: int, title: str) -> None:
    ...
    from mediaforge.downloader.job import JobStatus as _JS
