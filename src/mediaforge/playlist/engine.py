...
from mediaforge.playlist.exceptions import PlaylistError, PlaylistExpansionError
...
from mediaforge.playlist.queue import PlaylistQueue
from mediaforge.providers.metadata import ProviderMediaType
...
class PlaylistEngine:
    ...
    def _error_message(self, exc: Exception) -> str:
        if isinstance(exc, (PlaylistError, MediaForgeError)):
            return str(exc)
