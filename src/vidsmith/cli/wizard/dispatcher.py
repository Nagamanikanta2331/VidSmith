...
from vidsmith.cli.wizard.registry import WizardRegistry
from vidsmith.cli.wizard.wizards import (
    build_audio_wizard,
...
from vidsmith.cli.wizard.wizards.subtitles import build_subtitles_wizard
...
def dispatch_wizard(action: str, result: AnalysisResult | None = None) -> None:
    ...
    if direct_name is not None:
        if result is not None:
            from vidsmith.cli import executor as _exec
